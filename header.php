...
<head>
    ...
    <!-- Title  -->
    <title>Civil Engineers | Kishen Constructions</title>
...
<body>
    ...
    <div id="preloader">
        <div class="loading-text">Kishen Structural Consultants</div>
    </div>
    ...
    <nav class="navbar change navbar-expand-lg">
        <div class="container">
            ...
            <a class="logo" href="index.php">
                <img src="img/logo-light.png" alt="logo" style="width: 170px;">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="https://api.whatsapp.com/send/?phone=%2B919843880757&text&type=phone_number&app_absent=0" target="_blank" class="btn-curve btn-color mt-10" style="padding: 10px 10px;">
                            <span style="font-size: 13px; text-transform: initial;">Chat on Whatsapp</span>
                        </a>
                    </li>
                </ul>
